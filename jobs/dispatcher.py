...
def _dispatch_modal(job_type: str, **kwargs) -> str:
    ...
    if job_type == "process_image":
        ...
        process_fn = modal.Function.lookup(app_name, "process_image")
        ...
        analyze_fn = modal.Function.lookup(app_name, "analyze_quality")
        ...
        reprocess_fn = modal.Function.lookup(app_name, "reprocess_image")
